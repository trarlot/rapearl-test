...
function Buttons() {
    ...
    return (
        <div className="center-buttons">
            <button aria-label="Mode aléatoire" id="shuffle" onClick={toggle}>
            ...
            <button aria-label="Musique suivante" id="next" onClick={toggle}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <button aria-label="Lecture en boucle" id="repeat" onClick={toggle}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
