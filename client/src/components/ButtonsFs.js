...
function ButtonsFs() {
    ...
    return (
        <div className="center-buttonsFs">
            <button aria-label="Lecture aléatoire" id="shuffleFs">
            ...
            <button aria-label="Musique précédente" id="previousFs">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <button aria-label="Musique suivante" id="nextFs">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <button aria-label="Lecture en boucle" id="repeatFs">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
